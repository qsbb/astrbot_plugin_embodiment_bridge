...
def test_operator_page_is_discoverable_and_uses_page_bridge() -> None:
    ...
    assert '<script type="module" src="./app.js?v=1.4.0-4"></script>' in html
    assert '<link rel="stylesheet" href="./style.css?v=1.4.0-4" />' in html
    assert html.index("bridge-sdk.js") < html.index("./app.js?v=1.4.0-4")
